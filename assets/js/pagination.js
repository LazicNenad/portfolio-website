      ...
      var pagination = {
         initialize: function () {
            ...
            self.parseDataSource(attributes.dataSource, function (dataSource) {
               ...
               container[
                  attributes.position === "bottom" ? "append" : "prepend"
               ](el);
         ...
         observer: function () {
            ...
            el.delegate(".J-paginationjs-page", "click", function (event) {
               ...
               if (
                  self.callHook("beforePageOnClick", event, pageNumber) ===
                  false
               )
                  return false;
            ...
            el.delegate(".J-paginationjs-next", "click", function (event) {
               ...
               // Before next clicked
               if (
                  self.callHook("beforeNextOnClick", event, pageNumber) ===
                  false
               )
                  return false;
   ...
   function parameterChecker(args) {
      ...
      if (typeof args.dataSource === "string") {
         ...
         if (typeof args.locator === "undefined") {
            ...
            throwError(
               "" + args.locator + " is incorrect. (String | Function)"
            );
         }
      }
